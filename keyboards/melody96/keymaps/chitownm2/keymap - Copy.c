...
| BACKLIGHT    |        |        |        |        |        |        |        |        |        |        |        |                    | MOUSE  | MOUSE  | MOUSE  |        |

| TOGGLE       |        |        |        |        |        |        |        |        |        |        |        |                    |  LEFT  |   DN   | RIGHT  |        |

|______________|________|________|________|________|________|________|________|________|________|________|________|____________________|________|________|________|________|

|         |        |        |        |BACKLHT |BACKLHT |BACKLHT |        |        |        |        |        |                | MEDIA  | MOUSE  | MOUSE  | MOUSE  |        |

|         |        |        |        | DCRSE  |TOGGLE  |INCREASE|        |        |        |        |        |                |  PLYR  | BUT 1  | BUT 3  | BUT 2  |        |
...
|          |          |          |                  BROSWER HOME                          |        |        | MENU   |  PREV  |  PLAY  |  NEXT  |        |        | CALC   |
...
LAYOUT
(
    RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, KC_VOLU, KC_VOLD, KC_MUTE,
    ...
    BL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   KC_MS_L, KC_MS_D, KC_MS_R, _______,

    _______, _______, _______, _______, BL_DEC,  BL_TOGG, BL_INC,  _______, _______, _______, _______, _______, _______,          KC_MSEL, KC_BTN1, KC_BTN3, KC_BTN2, _______,

    _______, _______, _______,                            KC_WHOM,                            _______, _______, KC_APP, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_CALC),
};
